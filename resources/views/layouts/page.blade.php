...
<head>
    <!-- SEO Tags -->
    <meta name="keywords" content="tycho, verstraete, tycho verstraete, portfolio, software engineer, graphic designer, belgium, website, wordpress, php, js, html, css, {{ ucfirst(Route::currentRouteName()) }}">
